            ...
            <ul className="flex mt-auto text-xl h-full">
                <li className="list-menu flex mr-16 my-auto">
                    <a href="/" className="block ">
                        <span className="secondary-color-txt-x">
                            Home
                        </span>
                    </a>
                </li>
                ...
                <li className="list-menu flex mr-16 my-auto">
                    <a ref={dropdownBtn} href="javascript:void(0)" id="dropdown-btn" className="dropdown flex" onClick={dropdownClick} onWheel={dropdownWheel}>
                        <span className="my-1 secondary-color-txt-x" >Others</span>
                        <svg className="my-auto down" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 48 48"><path className="secondary-color-txt-x" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" d="M36 18L24 30L12 18" /></svg>
