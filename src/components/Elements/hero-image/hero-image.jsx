...
const HeroImage = () => {
            ...
            if (currentPath === "/") {
                if (window.innerWidth <= 992) {
                    if (window.innerWidth <= 576) {
                        if (window.innerHeight <= heroIconHeight + headerHeight * 5) {
                            heroImage.current.style.height = `calc(100vh + 400px)`;
                        } else {
                            heroImage.current.style.height = `100vh`;
                        }
                    } else if (window.innerWidth <= 768) {
                        if (window.innerHeight <= heroIconHeight + headerHeight * 4.5) {
                            if (window.innerWidth <= 576) {
    ...
    return (
        <div ref={heroImage} id="hero-image" className="flex shadow-2xl">
